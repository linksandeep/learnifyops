...
const toolsServicesMenuColumns = [
  {
    title: "Tools",
    intro: "In-house platforms supporting learning, placement and admissions.",
    items: navToolItems
  },
  {
    title: "Services",
...
const megaMenus = [
  ...
  },
  {
    ...
    footer: "Tools for students. Services for businesses.",
    ...
    <header className="site-header" ref={headerRef} onMouseLeave={() => setOpenMega(null)}>
      <div className="global-bar">
        <div className="container global-bar-inner">
          <span className="global-brandline"><Globe2 size={14} aria-hidden="true" /> LearnifyOps DBA Advisory</span>
          <span className="global-menu-line">DBA admissions <i /> university comparison <i /> curriculum guidance</span>
          <Link className="global-link" to="/contact" navigate={navigate}>Book Profile Review <ArrowRight size={13} aria-hidden="true" /></Link>
        </div>
      </div>
      ...
      <div className="container">
        <div className="universities-heading reveal">
          <div>
            ...
            <h2>Compare DBA routes before choosing a partner institution.</h2>
          </div>
          <div className="universities-intro">
            <p>LearnifyOps helps you compare eligibility fit, duration, delivery mode, curriculum focus, fee notes, documents and recognition information before you apply.</p>
            ...
            <div className="universities-compare-list" aria-label="What LearnifyOps compares">
              {["Eligibility fit", "Duration & delivery", "Curriculum focus", "Fees & documents", "Recognition notes", "Application timeline"].map((item) => (
      ...
      <div className="container contact-shell">
        <div className="contact-hero-card reveal">
          <div className="contact-hero-copy">
            ...
            <h1>Book a focused DBA profile review.</h1>
            <p>Share your background, leadership experience and research goals. We will help you understand pathway fit, university options, documents and next steps.</p>
          </div>
          <div className="contact-quick-grid" aria-label="Contact information">
            <a className="contact-icon-only" href="mailto:info@learnifyops.com" aria-label="Email info@learnifyops.com"><Mail size={18} /><strong>info@learnifyops.com</strong></a>
            <a className="contact-icon-only" href="tel:+447447177848" aria-label="Call +44 7447 177848"><Phone size={18} /><strong>+44 7447 177848</strong></a>
            <span><MapPin size={18} /><span>Support office</span><strong>UK & India</strong></span>
            <span><Globe2 size={18} /><span>Time zones</span><strong>UK · USA · Australia</strong></span>
          </div>
        </div>
        <form className="contact-form reveal" onSubmit={handleSubmit} aria-describedby="privacy-help form-status">
          <div className="contact-form-heading">
            <span>Profile review request</span>
            <p>Complete this short form and our team will contact you with the right next step.</p>
          </div>
  ...
  return (
    <>
      <PageHero
        ...
        title="Compare partner institutions with clear DBA admissions guidance."
        text="LearnifyOps helps you understand which DBA route fits your experience, goals, delivery preference, documents and budget before you apply."
      />
      ...
      <section className="section section-white">
        <div className="container">
          <SectionIntro
            ...
            icon={Globe2}
            title="A side-by-side review before formal enrollment."
            text="We compare eligibility, duration, delivery model, curriculum focus, fee notes, recognition information and application documents so you can choose with confidence."
          />
          <div className="value-grid">
            <article className="value-card reveal">
              <span className="icon-box"><FileText size={23} /></span>
              <h3>Profile Fit</h3>
              <p>Match your experience, academic record and leadership background to suitable DBA routes.</p>
            </article>
            <article className="value-card reveal">
              <span className="icon-box"><Users size={23} /></span>
              <h3>Documents & Requirements</h3>
              <p>Clarify transcripts, CV, research intent, English requirements and admissions documents before submission.</p>
            </article>
            <article className="value-card reveal">
              <span className="icon-box"><Building2 size={23} /></span>
              <h3>Curriculum & Fees</h3>
              <p>Compare duration, delivery, curriculum documents, fee notes and awarding route in one review.</p>
            </article>
            <article className="value-card reveal">
              <span className="icon-box"><ShieldCheck size={23} /></span>
              <h3>Transparent Next Steps</h3>
              <p>Know what happens after enquiry: profile review, shortlist, brochure or curriculum request and application guidance.</p>
            </article>
          </div>
        </div>
      </section>
      <FinalCta navigate={navigate} tone="partner" title="Request a side-by-side DBA route comparison before you apply." />
    </>
  );
}
